function scatterPlotChart(selector){
    ...
    var clr = d3.schemeAccent;//d3.scale.category20c();
    var myColor = d3.scaleOrdinal().domain(["Asia", "Europe", "Americas", "Africa", "Oceania"])
                                    .range(["#00BFFF","#DC143C"]);

    var tooltip = d3.select("#"+selector)
                                .append("div")
                                .style("opacity", 0)
                                .attr("class", "tooltipScat")
    ...
    var showTooltip = function(d) {
        tooltip.transition().duration(1200);
        tooltip.style("opacity", 1)
                .html("Country: " + d.country +"<br>"+"GDP: " + d.gdpPercap)
                .style("top", d3.mouse(this).attr("cy") + "px")
                .style("left",d3.mouse(this).attr("cx") + "px");
                 };
...
scatterPlotChart("scatterPlotChart", data);